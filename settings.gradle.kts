...
include(":tests:uniffi:ext-types:ext-errors")
...
include(":tests:uniffi:interface-throws")
include(":tests:uniffi:keywords")
include(":tests:uniffi:lib-with-bin")
...
include(":tests:uniffi:mutable-records")
...
include(":examples:swift-interop")
